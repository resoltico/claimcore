    ...
    let private vitestPart1 =
        set
            [
                ...
                "local diagnostic contracts > fingerprints the administration grammar independently of display text"
                "local diagnostic contracts > rejects mismatched actual HTTP status even for an otherwise valid host body"
                "local diagnostic contracts > validates every process and administration cause and hostile counterpart"
