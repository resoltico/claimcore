...
$mustRemainVisible = @(
    ...
    "eng/release/policy.test.mjs", "eng/release/publisher.test.mjs",
    "eng/release/reconciliation.test.mjs", "eng/release/publish-release.test.mjs",
    "eng/release/test-support.mjs", ".github/workflows/release.yml",
